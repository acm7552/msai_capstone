...
class ConfigurationManager:
    ...
    def define_arguments(self, argument_parser):
        ...
        argument_parser.add_argument('--dataset', type=str, default='artbench',
                                     help='Dataset to use for this study (aria or artbench)')
        argument_parser.add_argument('--choices', default=[1, 1, 1, 1, 1, 1, 1, 1],
                                     help='Dataset selection flags')
        argument_parser.add_argument('--epoch', type=int, default=10,
        ...
        argument_parser.add_argument('--save_path', type=str,
                                     default='/home/stu14/s16/acm7552/Capstone/scripts/LOTAsaves',
        ...
        argument_parser.add_argument('--gpu_id', type=str, default='1',
